...
* (Les chapitres sont sauvegarder sous forme de pages html, les images y sont stockés de façon binaire)
...
5. Les chapitres sont téléchargés sous formes de pages html (compatible mobile).
...
4. Une fois que toutes les images d'un chapitre sont entièrements téléchargés, les images sont convertis en binaire et sauvegardé a la suite dans une page html.
